...
# source: finam_grpc_client/models/grpc/orders.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    "",
    "finam_grpc_client/models/grpc/orders.proto",
)
