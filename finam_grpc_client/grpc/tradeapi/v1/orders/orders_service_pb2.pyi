...
import finam_grpc_client.grpc.tradeapi.v1.side_pb2
import finam_grpc_client.grpc.tradeapi.v1.trade_pb2
...
class OrderTradeResponse(google.protobuf.message.Message):
    ...
    @property
    def trades(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[finam_grpc_client.grpc.tradeapi.v1.trade_pb2.AccountTrade]:
        """Сделки"""
    ...
    def __init__(
        ...
        *,
        ...
        trades: collections.abc.Iterable[finam_grpc_client.grpc.tradeapi.v1.trade_pb2.AccountTrade] | None = ...,
    ) -> None: ...
...
class Order(google.protobuf.message.Message):
    ...
    symbol: builtins.str
    """Символ инструмента"""
    side: finam_grpc_client.grpc.tradeapi.v1.side_pb2.Side.ValueType
